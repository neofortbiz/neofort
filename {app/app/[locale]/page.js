        ...
        <div className="container">
          <div className="intro-grid-title">
            <div>
              ...
              <h2 className='home-h2-intro' style={{fontFamily:'Barlow Condensed,sans-serif',fontWeight:500,fontSize:'clamp(1.2625rem, 4vw, 1.9625rem)',color:'#1a1a1a',lineHeight:1.2,marginBottom:'0',letterSpacing:'.01em'}}>Tâmplărie PVC Salamander<br/>și Aluminiu Alumil</h2>
            </div>
            <div/>
          </div>
        ...
        <div className="container">
          <div className="why-grid-home">
            <div>
              ...
              <h2 className='home-h2-why' style={{fontFamily:'Barlow Condensed,sans-serif',fontWeight:500,fontSize:'clamp(1.2625rem, 4vw, 2.2625rem)',color:'#1a1a1a',lineHeight:1.2}}>Calitate și angajamente<br/>fără compromisuri</h2>
            </div>
      ...
      <section className="cta-section" style={{padding:'64px 0',background:'#111'}}>
        <div className="container">
          <div className="cta-inner-home">
            <div>
              <span style={{fontFamily:'Barlow Condensed,sans-serif',fontSize:'0.6625rem',letterSpacing:'.2em',textTransform:'uppercase',color:'#555',display:'block',marginBottom:'8px'}}>Contactați-ne</span>
