        ...
        <nav className="mobile-nav">
          ...
          <div className="mobile-langs" style={{display:'flex',alignItems:'center',justifyContent:'space-between'}}>
            ...
            <a href="https://wa.me/40752443435" target="_blank" rel="noopener noreferrer"
              style={{display:'inline-flex',alignItems:'center',gap:'6px',fontFamily:'Barlow Condensed,sans-serif',fontWeight:500,fontSize:'.6rem',letterSpacing:'.15em',textTransform:'uppercase',color:'#fff',background:'#25D366',padding:'8px 14px',textDecoration:'none',flexShrink:0}}>
