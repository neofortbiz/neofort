...
export default function Footer() {
  ...
  const COL_TEXTS = {
    ro: { products:'Produse', nzeb:'Sisteme nZEB', umbrire:'Sisteme Umbrire', info:'Info', brand:'Tâmplărie PVC · Aluminiu', schedule:'Program de Lucru', maps:'Vezi pe Google Maps', address:'Str. Theodor Aman Pictor nr.11, Sector 1, București 010776', gdpr:'Politica GDPR', cookies:'Politica Cookies', termeni:'Termeni și Condiții', servicii:'Servicii', despre:'Despre', blog:'Blog', pvc:'Tâmplărie PVC Salamander', aluminiu:'Tâmplărie Aluminiu Alumil', accesorii:'Accesorii pentru Tâmplărie', guides_title:'Ghiduri & Preturi', ghid_pvc:'Ghid Complet Tamplarie PVC', ghid_aluminiu:'Ghid Complet Tamplarie Aluminiu', ghid_umbrire:'Ghid Sisteme Umbrire', ghid_nzeb:'Ghid Sisteme nZEB', preturi_umbrire:'Preturi Sisteme Umbrire', guides_title:'Ghiduri & Prețuri', ghid_pvc:'Ghid Complet Tâmplărie PVC', ghid_aluminiu:'Ghid Complet Tâmplărie Aluminiu', ghid_umbrire:'Ghid Sisteme Umbrire', ghid_nzeb:'Ghid Sisteme nZEB', preturi_umbrire:'Prețuri Sisteme Umbrire', brand_desc:'Furnizăm tâmplărie PVC Salamander și aluminiu Alumil cu geam termopan certificat nZEB. Precadre Blaugelb Triotherm+, jaluzele Raffstore, rulouri aluminiu. Montaj profesional și livrare în toată Europa.', legal:'NEOFORT BIZ SRL · CUI RO30324211 · Reg. Com. J40/6928/2012 · EUID ROONRC.J40/6928/2012', reviews:'4.9★ · 50 Recenzii Google' },
    en: { products:'Products', nzeb:'nZEB Systems', umbrire:'Shading Systems', info:'Info', brand:'PVC · Aluminium Windows', schedule:'Opening Hours', maps:'View on Google Maps', address:'11 Theodor Aman Pictor St., Sector 1, Bucharest 010776', gdpr:'GDPR Policy', cookies:'Cookie Policy', termeni:'Terms & Conditions', servicii:'Services', despre:'About', blog:'Blog', pvc:'PVC Salamander Windows', aluminiu:'Aluminium Alumil Windows', accesorii:'Window Accessories', guides_title:'Guides & Prices', ghid_pvc:'Complete PVC Guide', ghid_aluminiu:'Complete Aluminium Guide', ghid_umbrire:'Shading Systems Guide', ghid_nzeb:'nZEB Systems Guide', preturi_umbrire:'Shading Prices', guides_title:'Guides & Prices', ghid_pvc:'Complete PVC Windows Guide', ghid_aluminiu:'Complete Aluminium Guide', ghid_umbrire:'Shading Systems Guide', ghid_nzeb:'nZEB Systems Guide', preturi_umbrire:'Shading System Prices', brand_desc:'We supply Salamander PVC and Alumil aluminium windows with nZEB-certified thermal glass. Blaugelb Triotherm+ precasings, Raffstore blinds, aluminium shutters. Professional installation and EU delivery.', legal:'NEOFORT BIZ SRL · VAT RO30324211 · Reg. J40/6928/2012 · EUID ROONRC.J40/6928/2012', reviews:'4.9★ · 50 Google Reviews' },
    de: { products:'Produkte', nzeb:'nZEB-Systeme', umbrire:'Beschattungssysteme', info:'Info', brand:'Kunststoff- · Aluminiumfenster', schedule:'Öffnungszeiten', maps:'Auf Google Maps anzeigen', address:'Str. Theodor Aman Pictor Nr. 11, Sektor 1, Bukarest 010776', gdpr:'Datenschutzrichtlinie', cookies:'Cookie-Richtlinie', termeni:'AGB', servicii:'Dienstleistungen', despre:'Über uns', blog:'Blog', pvc:'Kunststofffenster Salamander', aluminiu:'Aluminiumfenster Alumil', accesorii:'Fensterzubehör', guides_title:'Ratgeber & Preise', ghid_pvc:'PVC-Fenster Ratgeber', ghid_aluminiu:'Aluminiumfenster Ratgeber', ghid_umbrire:'Beschattung Ratgeber', ghid_nzeb:'nZEB Ratgeber', preturi_umbrire:'Beschattungspreise', guides_title:'Ratgeber & Preise', ghid_pvc:'Kompletter PVC-Fenster-Ratgeber', ghid_aluminiu:'Kompletter Aluminiumfenster-Ratgeber', ghid_umbrire:'Beschattungssysteme Ratgeber', ghid_nzeb:'nZEB-Systeme Ratgeber', preturi_umbrire:'Beschattungspreise', brand_desc:'Wir liefern Salamander Kunststoff- und Alumil Aluminiumfenster mit nZEB-zertifiziertem Isolierglas. Blaugelb Triotherm+ Vorfenster, Raffstore Jalousien, Aluminiumrollläden. Professionelle Montage und EU-Lieferung.', legal:'NEOFORT BIZ SRL · USt-ID RO30324211 · HR-Nr. J40/6928/2012 · EUID ROONRC.J40/6928/2012', reviews:'4.9★ · 50 Google-Bewertungen' },
    fr: { products:'Produits', nzeb:'Systèmes nZEB', umbrire:"Systèmes d'occultation", info:'Info', brand:'Menuiserie PVC · Aluminium', schedule:'Horaires d\'ouverture', maps:'Voir sur Google Maps', address:'11 rue Theodor Aman Pictor, Secteur 1, Bucarest 010776', gdpr:'Politique RGPD', cookies:'Politique de cookies', termeni:'CGV', servicii:'Services', despre:'À propos', blog:'Blog', pvc:'Menuiserie PVC Salamander', aluminiu:'Menuiserie Aluminium Alumil', accesorii:'Accessoires menuiserie', guides_title:'Guides & Prix', ghid_pvc:'Guide menuiserie PVC', ghid_aluminiu:'Guide menuiserie aluminium', ghid_umbrire:'Guide occultation', ghid_nzeb:'Guide systemes nZEB', preturi_umbrire:'Prix occultation', guides_title:'Guides & Prix', ghid_pvc:'Guide complet menuiserie PVC', ghid_aluminiu:'Guide complet menuiserie aluminium', ghid_umbrire:'Guide systemes occultation', ghid_nzeb:'Guide systemes nZEB', preturi_umbrire:'Prix systemes occultation', brand_desc:'Nous fournissons des menuiseries PVC Salamander et aluminium Alumil avec vitrage isolant certifié nZEB. Précadres Blaugelb Triotherm+, stores Raffstore, volets roulants aluminium. Pose professionnelle et livraison en Europe.', legal:'NEOFORT BIZ SRL · TVA RO30324211 · RC J40/6928/2012 · EUID ROONRC.J40/6928/2012', reviews:'4.9★ · 50 Avis Google' },
    es: { products:'Productos', nzeb:'Sistemas nZEB', umbrire:'Sistemas de Sombreado', info:'Info', brand:'Carpintería PVC · Aluminio', schedule:'Horario de atención', maps:'Ver en Google Maps', address:'C/ Theodor Aman Pictor 11, Sector 1, Bucarest 010776', gdpr:'Política GDPR', cookies:'Política de cookies', termeni:'Términos y Cond.', servicii:'Servicios', despre:'Sobre nosotros', blog:'Blog', pvc:'Carpintería PVC Salamander', aluminiu:'Carpintería Aluminio Alumil', accesorii:'Accesorios carpintería', guides_title:'Guías & Precios', ghid_pvc:'Guía carpintería PVC', ghid_aluminiu:'Guía carpintería aluminio', ghid_umbrire:'Guía sombreado', ghid_nzeb:'Guía sistemas nZEB', preturi_umbrire:'Precios sombreado', guides_title:'Guías & Precios', ghid_pvc:'Guía completa carpintería PVC', ghid_aluminiu:'Guía completa carpintería aluminio', ghid_umbrire:'Guía sistemas de sombreado', ghid_nzeb:'Guía sistemas nZEB', preturi_umbrire:'Precios sistemas sombreado', brand_desc:'Suministramos carpintería PVC Salamander y aluminio Alumil con vidrio aislante certificado nZEB. Premarcos Blaugelb Triotherm+, persianas Raffstore, cierres enrollables aluminio. Instalación profesional y entrega en Europa.', legal:'NEOFORT BIZ SRL · CIF RO30324211 · Reg. J40/6928/2012 · EUID ROONRC.J40/6928/2012', reviews:'4.9★ · 50 Reseñas Google' },
    it: { products:'Prodotti', nzeb:'Sistemi nZEB', umbrire:'Sistemi di Oscuramento', info:'Info', brand:'Infissi PVC · Alluminio', schedule:'Orari di apertura', maps:'Vedi su Google Maps', address:'Via Theodor Aman Pictor 11, Settore 1, Bucarest 010776', gdpr:'Politica GDPR', cookies:'Politica cookie', termeni:'Termini e Condizioni', servicii:'Servizi', despre:'Chi siamo', blog:'Blog', pvc:'Infissi in PVC Salamander', aluminiu:'Infissi in Alluminio Alumil', accesorii:'Accessori infissi', guides_title:'Guide & Prezzi', ghid_pvc:'Guida infissi PVC', ghid_aluminiu:'Guida infissi alluminio', ghid_umbrire:'Guida oscuramento', ghid_nzeb:'Guida sistemi nZEB', preturi_umbrire:'Prezzi oscuramento', guides_title:'Guide & Prezzi', ghid_pvc:'Guida completa infissi PVC', ghid_aluminiu:'Guida completa infissi alluminio', ghid_umbrire:'Guida sistemi oscuramento', ghid_nzeb:'Guida sistemi nZEB', preturi_umbrire:'Prezzi sistemi oscuramento', brand_desc:'Forniamo infissi PVC Salamander e alluminio Alumil con vetro termoisolante certificato nZEB. Precontrotelaio Blaugelb Triotherm+, veneziane Raffstore, tapparelle in alluminio. Installazione professionale e consegna in Europa.', legal:'NEOFORT BIZ SRL · P.IVA RO30324211 · Reg. J40/6928/2012 · EUID ROONRC.J40/6928/2012', reviews:'4.9★ · 50 Recensioni Google' },
  };
  const col = COL_TEXTS[locale] || COL_TEXTS.ro;

  // Sluguri pagini pillar per locala
  const PILLAR = {
                  ...
                  <div className="form-col form-col-client" style={{padding:'27px 32px',borderRight:'1px solid #2a2a2a'}}>
                    ...
                    <div style={{marginTop:'20px'}}>
                      ...
                      <label style={{display:'inline-flex',alignItems:'center',gap:'10px',cursor:'pointer'}}>
                        <span style={{fontFamily:'Barlow,sans-serif',fontWeight:300,fontSize:'.74rem',color:'#aaa',background:'#1e1e1e',border:'1px solid #2a2a2a',padding:'4px 10px',borderRadius:'2px',whiteSpace:'nowrap',userSelect:'none'}}>{ft.btn_file}</span>
                      ...
                      {files.length > 0 && <span style={{fontFamily:'Barlow Condensed,sans-serif',fontSize:'.6rem',color:'#999',display:'block',marginTop:'4px'}}>{files.length} {ft.files_sel}</span>}
                    </div>
                  </div>
        ...
        <div className="footer-grid-cols" style={{padding:'0 0 27px',borderBottom:'1px solid #1e1e1e',alignItems:'start'}}>
          <div className="footer-col-1">
            ...
            <a href="https://wa.me/40752443435" target="_blank" rel="noopener noreferrer"
              style={{display:'inline-flex',alignItems:'center',gap:'8px',fontFamily:'Barlow Condensed,sans-serif',fontWeight:500,fontSize:'.64rem',letterSpacing:'.18em',textTransform:'uppercase',color:'#fff',background:'#075E35',border:'none',padding:'10px 20px',textDecoration:'none',marginBottom:'16px',cursor:'pointer'}}>
          ...
          <div className="footer-col-3" style={{borderLeft:'1px solid #1e1e1e'}}>
            ...
            <ul className="footer-links">
              ...
              <li><Link href="/termeni-si-conditii">{col.termeni}</Link></li>
            </ul>
          </div>
          ...
          <div className="footer-col-4" style={{borderLeft:'1px solid #1e1e1e'}}>
            ...
            <address style={{fontFamily:'Barlow Condensed,sans-serif',fontSize:'.62rem',letterSpacing:'.04em',color:'#999',lineHeight:1.6,marginBottom:'10px',fontStyle:'normal'}}>
              {col.address}
            </address>
