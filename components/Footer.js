          ...
          <div style={{border:'1px solid #2a2a2a'}}>
            <div style={{display:'grid',gridTemplateColumns:'1fr 1.6fr 1.4fr'}}>
              ...
              <div style={{padding:'36px 32px'}}>
                ...
                {['Tâmplărie PVC Salamander','Tâmplărie Aluminiu Alumil','Geam Termoizolator 2 Foi','Geam Termoizolator 3 Foi','Precadre Blaugelb Triotherm+','Baghete Warm Edge','Bandă Butilică Etanșare','Benzi Etanșare Vapori','Profile de Renovare','Pervazuri de Interior','Pervazuri de Exterior','Jaluzele Venețiene Raffstore','Rulouri Exterioare Aluminiu','Sisteme Ventilație','Sisteme Culisante','Uși de Intrare Premium','Uși de Garaj'].map((item,i)=>(
            ...
            {/* Submit */}
            <button type="submit" style={{width:'100%',fontFamily:'Barlow Condensed,sans-serif',fontWeight:500,fontSize:'.76rem',letterSpacing:'.25em',textTransform:'uppercase',color:'#fff',background:'#1a1a1a',border:'none',borderTop:'1px solid #2a2a2a',padding:'22px 48px',cursor:'pointer',display:'block'}}>
              Trimite Solicitarea
            </button>
          </div>
        </div>
