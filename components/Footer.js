...
export default function Footer() {
  ...
  const PRODUSE_RAW = {
    ...
    fr: ['Menuiserie PVC Salamander','Menuiserie Aluminium Alumil','Verre isolant 2 feuilles','Verre isolant 3 feuilles','Précadres Blaugelb Triotherm+','Baguettes Warm Edge','Bande d\'étanchéité en butyle','Bandes d\'étanchéité vapeur','Profils de rénovation','Appuis de fenêtre intérieurs','Appuis de fenêtre extérieurs','Volets roulants en aluminium','Zipscreen Store Extérieur','Persiennes Vénitiennes Raffstore','Systèmes d\'aération','Systèmes coulissants','Portes d\'entrée premium','Portes de garage'],
