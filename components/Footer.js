          ...
          <div className="footer-col-1">
            ...
            <div style={{ display:'flex', alignItems:'center', gap:'12px', flexWrap:'wrap', marginBottom:'14px' }}>
              ...
              <a href="https://wa.me/40752443435" target="_blank" rel="noopener noreferrer"
                style={{ display:'inline-flex', alignItems:'center', gap:'6px', fontFamily:FF.cond, fontWeight:FW.medium, fontSize:FS.xs, letterSpacing:'.14em', textTransform:'uppercase', color:CL.white, background:'#25D366', padding:'7px 14px', textDecoration:'none', cursor:'pointer', whiteSpace:'nowrap' }}>
