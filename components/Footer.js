...
const CL = { white: '#fff', light: '#bbb', mid: '#666', dark: '#444' };
        ...
        <div className="footer-grid-cols" style={{ padding:'0 0 27px', borderBottom:'1px solid #1e1e1e', alignItems:'start' }}>
          ...
          <div className="footer-col-1">
            ...
            <a href="https://wa.me/40752443435" target="_blank" rel="noopener noreferrer"
              style={{ display:'inline-flex', alignItems:'center', gap:'8px', fontFamily:FF.cond, fontWeight:FW.medium, fontSize:FS.sm, letterSpacing:'.18em', textTransform:'uppercase', color:CL.white, background:'#25D366', border:'none', padding:'10px 20px', textDecoration:'none', marginBottom:'16px', cursor:'pointer' }}>
