...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    description: locale === 'ro' ? 'Tâmplărie PVC Salamander în București — cere o ofertă de preț personalizată, cu răspuns în 24h. Sisteme BluEvolution 92 și GreenEvolution 76, montaj propriu, 21 ani experiență, 5.0★ din 52 recenzii.'
               ...
               : locale === 'fr' ? 'Menuiserie PVC Salamander à Bucarest — demandez un devis prix personnalisé, réponse en 24h. Systèmes BluEvolution 92 et GreenEvolution 76, pose par notre équipe, 21 ans d\u2019expérience, 5.0★ sur 52 avis.'
               : locale === 'es' ? 'Carpintería PVC Salamander en Bucarest — solicita un presupuesto personalizado, respuesta en 24h. Sistemas BluEvolution 92 y GreenEvolution 76, montaje propio, 21 años de experiencia, 5.0★ de 52 reseñas.'
               : 'Infissi PVC Salamander a Bucarest — richiedi un preventivo prezzo personalizzato, risposta in 24h. Sistemi BluEvolution 92 e GreenEvolution 76, posa propria, 21 anni di esperienza, 5.0★ su 52 recensioni.',
