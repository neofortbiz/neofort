...
const SPECS = {
  ...
  gre76mdround: {
    ro:[['Profil PVC cu','6 camere'],['Etanșare','3 garnituri'],['Adâncime','76 mm'],['Transfer','Uw = 0,73 W/(m²K)'],['Vitraj','până la 48 mm'],['Protecție fonică','până la 47 dB'],['Anti-efracție','până la RC 3']],
    en:[['PVC profile with','6 chambers'],['Sealing','3 gaskets'],['Depth','76 mm'],['Transfer','Uw = 0.73 W/(m²K)'],['Glazing','up to 48 mm'],['Sound insulation','up to 47 dB'],['Burglar resistance','up to RC 3']],
    de:[['PVC-Profil mit','6 Kammern'],['Dichtung','3 Dichtungen'],['Bautiefe','76 mm'],['Transfer','Uw = 0,73 W/(m²K)'],['Verglasung','bis 48 mm'],['Schallschutz','bis 47 dB'],['Einbruchschutz','bis RC 3']],
    fr:[['Profil PVC avec','6 chambres'],['Étanchéité','3 joints'],['Profondeur','76 mm'],['Transfert','Uw = 0,73 W/(m²K)'],['Vitrage','jusqu\'à 48 mm'],['Protection phonique','jusqu\'à 47 dB'],['Anti-effraction','jusqu\'à RC 3']],
    es:[['Perfil PVC con','6 cámaras'],['Estanqueidad','3 juntas'],['Profundidad','76 mm'],['Transferencia','Uw = 0,73 W/(m²K)'],['Acristalamiento','hasta 48 mm'],['Aislamiento acústico','hasta 47 dB'],['Antirrobo','hasta RC 3']],
    it:[['Profilo PVC con','6 camere'],['Tenuta','3 guarnizioni'],['Profondità','76 mm'],['Trasmittanza','Uw = 0,73 W/(m²K)'],['Vetro','fino a 48 mm'],['Isolamento acustico','fino a 47 dB'],['Antieffrazione','fino a RC 3']],
  },
  gre76mdflex: {
    ro:[['Profil PVC cu','6 camere'],['Etanșare','3 garnituri'],['Adâncime','76 mm'],['Transfer','Uw = 0,73 W/(m²K)'],['Vitraj','până la 48 mm'],['Protecție fonică','până la 47 dB'],['Anti-efracție','până la RC 3']],
    en:[['PVC profile with','6 chambers'],['Sealing','3 gaskets'],['Depth','76 mm'],['Transfer','Uw = 0.73 W/(m²K)'],['Glazing','up to 48 mm'],['Sound insulation','up to 47 dB'],['Burglar resistance','up to RC 3']],
  ...
  gre76adflex: {
    ro:[['Profil PVC cu','6 camere'],['Etanșare','2 garnituri'],['Adâncime','76 mm'],['Transfer','Uw = 0,73 W/(m²K)'],['Vitraj','până la 48 mm'],['Protecție fonică','până la 47 dB'],['Anti-efracție','până la RC 3']],
    en:[['PVC profile with','6 chambers'],['Sealing','2 gaskets'],['Depth','76 mm'],['Transfer','Uw = 0.73 W/(m²K)'],['Glazing','up to 48 mm'],['Sound insulation','up to 47 dB'],['Burglar resistance','up to RC 3']],
    de:[['PVC-Profil mit','6 Kammern'],['Dichtung','2 Dichtungen'],['Bautiefe','76 mm'],['Transfer','Uw = 0,73 W/(m²K)'],['Verglasung','bis 48 mm'],['Schallschutz','bis 47 dB'],['Einbruchschutz','bis RC 3']],
    fr:[['Profil PVC avec','6 chambres'],['Étanchéité','2 joints'],['Profondeur','76 mm'],['Transfert','Uw = 0,73 W/(m²K)'],['Vitrage','jusqu\'à 48 mm'],['Protection phonique','jusqu\'à 47 dB'],['Anti-effraction','jusqu\'à RC 3']],
    es:[['Perfil PVC con','6 cámaras'],['Estanqueidad','2 juntas'],['Profundidad','76 mm'],['Transferencia','Uw = 0,73 W/(m²K)'],['Acristalamiento','hasta 48 mm'],['Aislamiento acústico','hasta 47 dB'],['Antirrobo','hasta RC 3']],
    it:[['Profilo PVC con','6 camere'],['Tenuta','2 guarnizioni'],['Profondità','76 mm'],['Trasmittanza','Uw = 0,73 W/(m²K)'],['Vetro','fino a 48 mm'],['Isolamento acustico','fino a 47 dB'],['Antieffrazione','fino a RC 3']],
  },
};
...
const DESCS = {
  ...
  gre76mdround: {
    ro:'Profil PVC GreenEvolution cu muchii rotunjite, 6 camere și adâncime de 76mm. Transfer termic Uw = 0,73 W/(m²K), geam până la 48mm, izolare fonică până la 47 dB și protecție anti-efracție RC 3.',
    en:'GreenEvolution PVC profile with rounded edges, 6 chambers and 76mm depth. Thermal transfer Uw = 0.73 W/(m²K), glazing up to 48mm, sound insulation up to 47 dB and RC 3 burglar resistance.',
    de:'GreenEvolution PVC-Profil mit abgerundeten Kanten, 6 Kammern und 76mm Bautiefe. Wärmedurchgang Uw = 0,73 W/(m²K), Verglasung bis 48mm, Schallschutz bis 47 dB und Einbruchschutz RC 3.',
    fr:'Profil PVC GreenEvolution à angles arrondis, 6 chambres et profondeur de 76mm. Transfert thermique Uw = 0,73 W/(m²K), vitrage jusqu\'à 48mm, isolation phonique jusqu\'à 47 dB et anti-effraction RC 3.',
    es:'Perfil PVC GreenEvolution con cantos redondeados, 6 cámaras y profundidad de 76mm. Transferencia Uw = 0,73 W/(m²K), acristalamiento hasta 48mm, aislamiento acústico hasta 47 dB y antirrobo RC 3.',
    it:'Profilo PVC GreenEvolution con bordi arrotondati, 6 camere e profondità di 76mm. Trasmittanza Uw = 0,73 W/(m²K), vetro fino a 48mm, isolamento acustico fino a 47 dB e antieffrazione RC 3.',
  },
  gre76mdflex: {
    ro:'Profil PVC GreenEvolution flexibil cu 6 camere și adâncime de 76mm. Transfer termic Uw = 0,73 W/(m²K), geam până la 48mm, izolare fonică până la 47 dB și protecție anti-efracție RC 3.',
    en:'Flexible GreenEvolution PVC profile with 6 chambers and 76mm depth. Thermal transfer Uw = 0.73 W/(m²K), glazing up to 48mm, sound insulation up to 47 dB and RC 3 burglar resistance.',
    de:'Flexibles GreenEvolution PVC-Profil mit 6 Kammern und 76mm Bautiefe. Wärmedurchgang Uw = 0,73 W/(m²K), Verglasung bis 48mm, Schallschutz bis 47 dB und Einbruchschutz RC 3.',
    fr:'Profil PVC GreenEvolution flexible, 6 chambres et profondeur de 76mm. Transfert thermique Uw = 0,73 W/(m²K), vitrage jusqu\'à 48mm, isolation phonique jusqu\'à 47 dB et anti-effraction RC 3.',
    es:'Perfil PVC GreenEvolution flexible con 6 cámaras y profundidad de 76mm. Transferencia Uw = 0,73 W/(m²K), acristalamiento hasta 48mm, aislamiento acústico hasta 47 dB y antirrobo RC 3.',
    it:'Profilo PVC GreenEvolution flessibile, 6 camere e profondità di 76mm. Trasmittanza Uw = 0,73 W/(m²K), vetro fino a 48mm, isolamento acustico fino a 47 dB e antieffrazione RC 3.',
  },
  gre76adflex: {
    ro:'Profil PVC GreenEvolution economic cu 6 camere, 2 garnituri și adâncime de 76mm. Transfer termic Uw = 0,73 W/(m²K), geam până la 48mm, izolare fonică până la 47 dB și protecție anti-efracție RC 3.',
    en:'Economic GreenEvolution PVC profile with 6 chambers, 2 gaskets and 76mm depth. Thermal transfer Uw = 0.73 W/(m²K), glazing up to 48mm, sound insulation up to 47 dB and RC 3 burglar resistance.',
    de:'Wirtschaftliches GreenEvolution PVC-Profil mit 6 Kammern, 2 Dichtungen und 76mm Bautiefe. Wärmedurchgang Uw = 0,73 W/(m²K), Verglasung bis 48mm, Schallschutz bis 47 dB und Einbruchschutz RC 3.',
    fr:'Profil PVC GreenEvolution économique, 6 chambres, 2 joints et profondeur de 76mm. Transfert thermique Uw = 0,73 W/(m²K), vitrage jusqu\'à 48mm, isolation phonique jusqu\'à 47 dB et anti-effraction RC 3.',
    es:'Perfil PVC GreenEvolution económico con 6 cámaras, 2 juntas y profundidad de 76mm. Transferencia Uw = 0,73 W/(m²K), acristalamiento hasta 48mm, aislamiento acústico hasta 47 dB y antirrobo RC 3.',
    it:'Profilo PVC GreenEvolution economico, 6 camere, 2 guarnizioni e profondità di 76mm. Trasmittanza Uw = 0,73 W/(m²K), vetro fino a 48mm, isolamento acustico fino a 47 dB e antieffrazione RC 3.',
  },
};
