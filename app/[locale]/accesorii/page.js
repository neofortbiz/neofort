    ...
    <>
      ...
      <section className="py-14 bg-[#111]">
        <div className="container mx-auto px-6 flex flex-col items-center text-center gap-6 md:flex-row md:justify-between md:text-left">
          ...
          <Link href="/contact" className="bg-accesorii text-white font-condensed text-[0.7rem] tracking-[0.18em] uppercase font-semibold px-8 py-4 hover:bg-orange-700 transition-colors duration-200 shrink-0">
            Cerere Ofertă
          </Link>
        </div>
      </section>
