...
const TEAM_DESPRE = [
  ...
  },
  {
    ...
    bio: {
      ro: 'Specialist în consultanță pentru clienți rezidențiali — ferestre PVC Salamander, jaluzele exterioare și sisteme nZEB. Asigură ofertele personalizate în 48 de ore.',
      en: 'Specialist in consulting for residential clients — Salamander PVC windows, exterior blinds and nZEB systems. Provides personalised quotes within 48 hours.',
      de: 'Spezialistin für die Beratung von Privatkunden — Salamander PVC-Fenster, Außenjalousien und nZEB-Systeme. Erstellt individuelle Angebote innerhalb von 48 Stunden.',
      fr: "Spécialiste en conseil pour les clients résidentiels — fenêtres PVC Salamander, stores extérieurs et systèmes nZEB. Fournit des devis personnalisés en 48 heures.",
