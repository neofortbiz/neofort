...
const PRODUCTS = {
  ...
  'greenevolution-76-md-round': {
    ...
    specs: {
      ...
      en:[['Construction depth','76 mm'],['Chambers','6 chambers'],['Visible height','118 mm'],['Profile type','Rounded (MD ROUND)'],['EPDM gaskets','2 EPDM gaskets'],['Reinforcement','Galv. steel 1.5 / 2.0 mm'],['Compatible glass','24 – 48 mm'],['Hardware','Roto NT / NX silver'],['Min. threshold','13 mm'],['Sash weight','Max. 180 kg'],['Profile class','A'],['Recyclability','100%'],],
      de:[['Bautiefe','76 mm'],['Kammern','6 Kammern'],['Sichtbreite','118 mm'],['Profiltyp','Gerundet (MD ROUND)'],['EPDM-Dichtungen','2 EPDM-Dichtungen'],['Verstärkung','Verz. Stahl 1,5 / 2,0 mm'],['Verglasung','24 – 48 mm'],['Beschläge','Roto NT / NX'],['Schwelle','13 mm'],['Gewicht','Max. 180 kg'],['Klasse','A'],['Recycelbar','100%'],],
      fr:[['Profondeur','76 mm'],['Chambres','6 chambres'],['Hauteur visible','118 mm'],['Profil','Arrondi (MD ROUND)'],['Joints EPDM','2 joints EPDM'],['Armature','Acier galv.'],['Vitrage','24 – 48 mm'],['Ferrures','Roto NT / NX'],['Seuil','13 mm'],['Poids','Max. 180 kg'],['Classe','A'],['Recyclable','100%'],],
