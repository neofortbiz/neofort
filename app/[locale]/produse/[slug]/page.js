...
const PRODUCTS = {
  ...
  'greenevolution-76-md-round': {
    ...
    breadcrumb_parent_href: '/tamplarie-pvc',
    name: {
      ro:'Profil PVC Salamander GreenEvolution 76 MD ROUND – 6 camere, design rotunjit',
      en:'Salamander GreenEvolution 76 MD ROUND PVC Profile – 6 Chambers, Rounded Design',
      de:'Salamander GreenEvolution 76 MD ROUND Kunststoffprofil – 6 Kammern, Rundes Design',
      fr:'Profil PVC Salamander GreenEvolution 76 MD ROUND – 6 Chambres, Design Arrondi',
      es:'Perfil PVC Salamander GreenEvolution 76 MD ROUND – 6 Cámaras, Diseño Redondeado',
      it:'Profilo PVC Salamander GreenEvolution 76 MD ROUND – 6 Camere, Design Arrotondato',
    },
    tagline: {
      ro:'Sistem PVC hexacameral de înaltă performanță la 76 mm — 3 garnituri mediane, certificat nZEB, raport calitate-preț optim.',
      en:'High-performance 76 mm hexachamber PVC system — 3 middle gaskets, nZEB certified, optimal value for money.',
      de:'76 mm Hochleistungs-Sechskammer-Kunststoffsystem — 3 Mitteldichtungen, nZEB-zertifiziert, optimales Preis-Leistungs-Verhältnis.',
      fr:'Système PVC hexacaméral haute performance à 76 mm — 3 joints médians, certifié nZEB, rapport qualité-prix optimal.',
      es:'Sistema PVC hexacameral de alto rendimiento a 76 mm — 3 juntas medianas, certificado nZEB, óptima relación calidad-precio.',
      it:'Sistema PVC esacamerale ad alte prestazioni a 76 mm — 3 guarnizioni mediane, certificato nZEB, ottimo rapporto qualità-prezzo.',
    },
    specs: {
      ro:[['Adâncime constructivă','76 mm'],['Număr camere','6 camere'],['Înălțime vizibilă','118 mm'],['Tip profil','Rotunjit (MD ROUND)'],['Garnituri EPDM','3 (inclusiv garnitură mediană)'],['Armătură','Oțel zincat 1,5 / 2,0 mm'],['Geam compatibil','24 – 48 mm'],['Feronerie','Roto NT / NX argintie'],['Prag minim','13 mm'],['Greutate cercevea','Max. 180 kg'],['Clasă profil','A'],['Reciclabilitate','100%'],],
      en:[['Construction depth','76 mm'],['Chambers','6 chambers'],['Visible height','118 mm'],['Profile type','Rounded (MD ROUND)'],['EPDM gaskets','3 (incl. middle gasket)'],['Reinforcement','Galv. steel 1.5 / 2.0 mm'],['Compatible glass','24 – 48 mm'],['Hardware','Roto NT / NX silver'],['Min. threshold','13 mm'],['Sash weight','Max. 180 kg'],['Profile class','A'],['Recyclability','100%'],],
      de:[['Bautiefe','76 mm'],['Kammern','6 Kammern'],['Sichtbreite','118 mm'],['Profiltyp','Gerundet (MD ROUND)'],['EPDM-Dichtungen','3 (inkl. Mitteldichtung)'],['Verstärkung','Verz. Stahl 1,5 / 2,0 mm'],['Verglasung','24 – 48 mm'],['Beschläge','Roto NT / NX'],['Schwelle','13 mm'],['Gewicht','Max. 180 kg'],['Klasse','A'],['Recycelbar','100%'],],
      fr:[['Profondeur','76 mm'],['Chambres','6 chambres'],['Hauteur visible','118 mm'],['Profil','Arrondi (MD ROUND)'],['Joints EPDM','3 (dont joint médian)'],['Armature','Acier galv.'],['Vitrage','24 – 48 mm'],['Ferrures','Roto NT / NX'],['Seuil','13 mm'],['Poids','Max. 180 kg'],['Classe','A'],['Recyclable','100%'],],
      es:[['Profundidad','76 mm'],['Cámaras','6'],['Altura visible','118 mm'],['Perfil','Redondeado'],['Juntas EPDM','3 (con junta media)'],['Refuerzo','Acero galv.'],['Vidrio','24 – 48 mm'],['Herraje','Roto NT / NX'],['Umbral','13 mm'],['Peso','Max. 180 kg'],['Clase','A'],['Reciclable','100%'],],
  ...
  'greenevolution-76-md-flex': {
    ...
    breadcrumb_parent_href: '/tamplarie-pvc',
    name: {
      ro:'Profil PVC Salamander GreenEvolution 76 MD FLEX – 6 camere, design drept',
      en:'Salamander GreenEvolution 76 MD FLEX PVC Profile – 6 Chambers, Straight Design',
      de:'Salamander GreenEvolution 76 MD FLEX Kunststoffprofil – 6 Kammern, Gerades Design',
      fr:'Profil PVC Salamander GreenEvolution 76 MD FLEX – 6 Chambres, Design Droit',
      es:'Perfil PVC Salamander GreenEvolution 76 MD FLEX – 6 Cámaras, Diseño Recto',
      it:'Profilo PVC Salamander GreenEvolution 76 MD FLEX – 6 Camere, Design Dritto',
    },
    tagline: {
      ro:'GreenEvolution 76 cu design drept modern și garnitură mediană — performanță nZEB la cost accesibil.',
      en:'GreenEvolution 76 with modern straight design and middle gasket — nZEB performance at accessible cost.',
      de:'GreenEvolution 76 mit modernem geradem Design und Mitteldichtung — nZEB-Leistung zu erschwinglichen Kosten.',
      fr:'GreenEvolution 76 avec design droit moderne et joint médian — performance nZEB à coût accessible.',
      es:'GreenEvolution 76 con diseño recto moderno y junta mediana — rendimiento nZEB a coste accesible.',
      it:'GreenEvolution 76 con design dritto moderno e guarnizione mediana — prestazioni nZEB a costo accessibile.',
    },
    specs: {
      ...
      en:[['Depth','76 mm'],['Chambers','6'],['Visible','118 mm'],['Design','Straight (MD FLEX)'],['Gaskets','3 EPDM + middle'],['Reinforcement','Galv. steel'],['Glass','24–48 mm'],['Hardware','Roto NT/NX'],['Threshold','13 mm'],['Weight','180 kg max.'],['Class','A'],['Recyclable','100%'],],
      de:[['Tiefe','76 mm'],['Kammern','6'],['Sicht','118 mm'],['Design','Gerade (MD FLEX)'],['Dichtungen','3 EPDM + Mitte'],['Verstärkung','Verz. Stahl'],['Glas','24–48 mm'],['Beschläge','Roto NT/NX'],['Schwelle','13 mm'],['Gewicht','180 kg max.'],['Klasse','A'],['Recycelbar','100%'],],
      fr:[['Profondeur','76 mm'],['Chambres','6'],['Visible','118 mm'],['Design','Droit (MD FLEX)'],['Joints','3 EPDM + médian'],['Armature','Acier galv.'],['Verre','24–48 mm'],['Ferrures','Roto NT/NX'],['Seuil','13 mm'],['Poids','180 kg max.'],['Classe','A'],['Recyclable','100%'],],
      es:[['Profundidad','76 mm'],['Cámaras','6'],['Visible','118 mm'],['Diseño','Recto (MD FLEX)'],['Juntas','3 EPDM + media'],['Refuerzo','Acero galv.'],['Vidrio','24–48 mm'],['Herraje','Roto NT/NX'],['Umbral','13 mm'],['Peso','180 kg máx.'],['Clase','A'],['Reciclable','100%'],],
      it:[['Profondità','76 mm'],['Camere','6'],['Visibile','118 mm'],['Design','Dritto (MD FLEX)'],['Guarnizioni','3 EPDM + mediana'],['Armatura','Acciaio galv.'],['Vetro','24–48 mm'],['Ferramenta','Roto NT/NX'],['Soglia','13 mm'],['Peso','180 kg max.'],['Classe','A'],['Riciclabile','100%'],],
    },
    perf: {
    ...
    advantages: {
      ro:['Design drept FLEX modern — linii curate, perfect pentru arhitectura contemporană și proiecte noi','Garnitură mediană MD — etanșare în 3 puncte la 76 mm adâncime, performanță superioară gamei standard 5 camere','6 camere de izolare — Uw 0,73 W/m²K standard, compatibil cu normele nZEB','Cel mai bun raport calitate-preț din gama Salamander — clasa A certificată la cost mediu de producție','Compatibil geam 24–48 mm — dublu și triplu termoizolant, inclusiv soluții fonoizolante','Recomandat pentru ansambluri rezidențiale noi, blocuri și clădiri de birouri low-rise'],
  ...
  'greenevolution-76-ad-flex': {
    ...
    breadcrumb_parent_href: '/tamplarie-pvc',
    name: {
      ro:'Profil PVC Salamander GreenEvolution 76 AD FLEX – 6 camere, design drept avansat',
      en:'Salamander GreenEvolution 76 AD FLEX PVC Profile – 6 Chambers, Advanced Straight Design',
      de:'Salamander GreenEvolution 76 AD FLEX Kunststoffprofil – 6 Kammern, Fortgeschrittenes gerades Design',
      fr:'Profil PVC Salamander GreenEvolution 76 AD FLEX – 6 Chambres, Design Droit Avancé',
      es:'Perfil PVC Salamander GreenEvolution 76 AD FLEX – 6 Cámaras, Diseño Recto Avanzado',
      it:'Profilo PVC Salamander GreenEvolution 76 AD FLEX – 6 Camere, Design Dritto Avanzato',
    },
    tagline: {
      ro:'Varianta avansată GreenEvolution 76 cu design drept — 6 camere, 2 garnituri mediane, Uw optim.',
      en:'GreenEvolution 76 advanced variant with straight design — 6 chambers, 2 middle gaskets, optimal Uw.',
      de:'Fortgeschrittene GreenEvolution 76 Variante mit geradem Design — 6 Kammern, 2 Mitteldichtungen, optimaler Uw.',
      fr:'Variante avancée GreenEvolution 76 avec design droit — 6 chambres, 2 joints médians, Uw optimal.',
      es:'Variante avanzada GreenEvolution 76 con diseño recto — 6 cámaras, 2 juntas medianas, Uw óptimo.',
      it:'Variante avanzata GreenEvolution 76 con design dritto — 6 camere, 2 guarnizioni mediane, Uw ottimale.',
    },
    specs: {
      ro:[['Adâncime','76 mm'],['Camere','6 camere'],['Vizibil','118 mm'],['Design','Drept AD FLEX'],['Garnituri','2 EPDM mediane'],['Armătură','Oțel zincat'],['Geam','24–48 mm'],['Feronerie','Roto NT/NX'],['Prag','13 mm'],['Greutate','180 kg max.'],['Clasă','A'],['Reciclabil','100%'],],
...
const UI = {
  ...
  de: { back:'← Zurück', all_products:'Alle Produkte', specs_title:'Technische Daten', perf_title:'Zertifizierte Leistungen', adv_title:'Hauptvorteile', cta_h:'Angebot anfordern für', cta_sub:'Berater verfügbar Mo–Fr, 10:00–18:00', cta_btn:'Angebot anfordern', cta_call:'Jetzt anrufen', related:'Ähnliche Produkte' },
  fr: { back:'← Retour', all_products:'Tous les produits', specs_title:'Caractéristiques techniques', perf_title:'Performances certifiées', adv_title:'Avantages clés', cta_h:'Demander un devis pour', cta_sub:'Conseillers disponibles Lun–Ven, 10h–18h', cta_btn:'Demander un devis', cta_call:'Appeler maintenant', related:'Produits connexes' },
  es: { back:'← Volver', all_products:'Todos los productos', specs_title:'Especificaciones técnicas', perf_title:'Rendimiento certificado', adv_title:'Ventajas clave', cta_h:'Solicitar presupuesto para', cta_sub:'Consultores disponibles Lun–Vie, 10:00–18:00', cta_btn:'Pedir presupuesto', cta_call:'Llamar ahora', related:'Productos relacionados' },
