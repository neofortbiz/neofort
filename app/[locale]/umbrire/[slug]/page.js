...
const PRODUCTS = {
  ...
  'rulouri-exterioare-aluminiu': {
    ...
    tagline: {
      ro:'Rulouri exterioare din aluminiu cu acționare electrică Somfy — reducere până la 70% câștig solar, izolare termică nocturnă, antiefracție RC3.',
    ...
    specs: {
      ro:[['Material lamele','Aluminiu extrudat izolat'],['Grosime lamelă','7,5 – 19,5 mm'],['Acționare','Electrică (motor Somfy) / Manuală'],['Casetă','Aplicată sau suprapusă / Încastrată'],['Ghidaje','PVC sau aluminiu'],['Lățime maximă','4500 mm'],['Înălțime maximă','3000 mm'],['Culori','Gamă completă RAL + texturi lemn'],['Automatizare','Timer, senzor vânt, domotică'],['Antiefracție','RC3 (ghidaje securizate)'],],
      ...
      it:[['Materiale lamella','Alluminio estruso isolato'],['Spessore lamella','7,5 – 19,5 mm'],['Azionamento','Elettrico (motore Somfy) / Manuale'],['Cassonetto','Applicato o incassato'],['Guide','PVC o alluminio'],['Largh. max.','4500 mm'],['Alt. max.','3000 mm'],['Colori','Gamma RAL completa + legno'],['Automazione','Timer, sensore vento, domotica'],['Antieffrazione','RC3 (guide sicure)'],],
    },
    perf: {
      ro:[['Reducere câștig solar','până la 70%'],['Izolare termică nocturnă','ΔU ≈ 0,3 W/m²K suplimentar'],['Izolare fonică','+ 3–5 dB față de fereastră singură'],['Rezistență vânt','până la 1050 Pa'],['Antiefracție RC3','variante cu ghidaje securizate'],['Compatibilitate','orice fereastră PVC sau aluminiu'],],
    ...
    seo_text: {
      ro:'Rulourile exterioare din aluminiu reprezintă cel mai eficient sistem de protecție solară activă pentru ferestre, reducând câștigul solar în lunile de vară cu până la 70% și menținând temperatura interioară semnificativ mai scăzută fără a pune presiune suplimentară pe sistemul de aer condiționat. Lamelele extrudate din aluminiu izolat, disponibile în grosimi de 7,5 mm până la 19,5 mm, asigură atât o rigiditate structurală superioară față de lamelele din plastic, cât și o rezistență la efracție certificată până la RC3 în variantele cu ghidaje securizate — performanță imposibilă cu rulourile din PVC sau aluminiu neizolat. Coborât complet noaptea, ruloul adaugă un strat suplimentar de izolare de ΔU ≈ 0,3 W/m²K, reducând pierderile de căldură prin fereastră cu până la 20% pe timp de noapte de iarnă. Sistemul este compatibil cu orice fereastră PVC sau aluminiu deja montată, poate fi integrat în domotică prin motor tubular Somfy cu control WiFi, Zigbee sau KNX, și este disponibil în toată paleta RAL plus texturi imitație lemn. Neofort BIZ furnizează și montează rulouri exterioare din aluminiu în București și toată Europa, cu consultanță gratuită și calcul al dimensionării înainte de comandă.',
  ...
  'jaluzele-venetiene-raffstore': {
    ...
    perf: {
      ro:[['Reducere câștig solar','până la 85%'],['Control luminos','0 – 100% (orientare lamele)'],['Lumină difuză cu vedere păstrată','Da — la orice poziție intermediară'],['Rezistență vânt','Clasa 5 · 1200 Pa'],['Standard european','EN 13561'],['Compatibil domotică BMS','KNX, Zigbee, WiFi'],],
    ...
    advantages: {
      ro:['Control solar de precizie — lamele orientabile 0°–90° permit dozarea exactă a luminii naturale fără perdea sau stor opac, mențin vederea spre exterior','Reducere câștig solar până la 85% — superior rulourilor opace la lumina directă, ideal pentru birouri și locuințe cu fațade suice sau vestice','Vedere păstrată la orice poziție — spre deosebire de rulouri, Raffstore permite exterior vizibil chiar cu jaluzeaua coborâtă complet','Rezistență vânt Clasa 5 · 1200 Pa — certificat EN 13561, cel mai înalt standard european pentru jaluzele exterioare','Compatibil cu domotica și BMS — KNX, Zigbee, WiFi, Somfy TaHoma, control de pe telefon sau integrat în sistemul clădirii','Lățime totală până la 5000 mm — o singură jaluzeală poate acoperi o fereastră mare sau o ușă culisantă în întregime'],
