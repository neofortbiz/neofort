...
export async function generateMetadata({ params }) {
  ...
  const descs = {
    ...
    en: 'Neofort BIZ — PVC Salamander BluEvolution 92 and Alumil aluminium joinery manufacturer. nZEB thermal glass, Blaugelb precasings, Raffstore blinds. Professional installation, EU delivery. 21 years experience.',
    de: 'Neofort BIZ — Hersteller von PVC Salamander BluEvolution 92 und Alumil Aluminiumfenstern. nZEB Wärmeschutzverglasung, Blaugelb Vorfenstermontage, Raffstore Jalousien. Professionelle Montage, EU-Lieferung. 21 Jahre Erfahrung.',
    fr: 'Neofort BIZ — fabricant menuiserie PVC Salamander BluEvolution 92 et aluminium Alumil. Vitrage thermique nZEB, précadres Blaugelb, stores Raffstore. Montage professionnel, livraison Europe. 21 ans d\'expérience.',
    es: 'Neofort BIZ — fabricante carpintería PVC Salamander BluEvolution 92 y aluminio Alumil. Vidrio térmico nZEB, premarcos Blaugelb, persianas Raffstore. Montaje profesional, entrega Europa. 21 años de experiencia.',
    it: 'Neofort BIZ — produttore serramenti PVC Salamander BluEvolution 92 e alluminio Alumil. Vetro termico nZEB, precassonetti Blaugelb, persiane Raffstore. Montaggio professionale, consegna Europa. 21 anni di esperienza.',
  };
  return {
    ...
    openGraph: {
      type: 'website',
      url: `https://www.neofort-biz.ro/${locale}`,
      title: titles[locale] || titles.ro,
      description: descs[locale] || descs.ro,
      ...
      locale: locale === 'ro' ? 'ro_RO' : locale === 'en' ? 'en_US' : `${locale}_${locale.toUpperCase()}`,
    },
    twitter: {
      ...
      title: titles[locale] || titles.ro,
      description: descs[locale] || descs.ro,
      images: ['https://www.neofort-biz.ro/og-image.jpg'],
    },
  };
}
...
const schema = {
  ...
  "@graph": [
    {
      "@type": "LocalBusiness",
      "@id": "https://www.neofort-biz.ro/#business",
      "name": "Neofort BIZ",
      "url": "https://www.neofort-biz.ro",
      "logo": "https://www.neofort-biz.ro/logo.png",
      "description": "Producător și furnizor tâmplărie PVC Salamander, aluminiu Alumil, geam termoizolator nZEB, precadre Blaugelb Triotherm+, jaluzele Raffstore, rulouri aluminiu. Montaj profesional și livrare în toată Europa. 21 ani experiență.",
      "foundingDate": "2003",
      "telephone": ["+40215280661", "+40752443435"],
      "email": "oferte@neofort-biz.ro",
      "address": { "@type": "PostalAddress", "streetAddress": "Strada Theodor Aman Pictor 11", "addressLocality": "București", "addressRegion": "Sector 1", "postalCode": "010776", "addressCountry": "RO" },
      "geo": { "@type": "GeoCoordinates", "latitude": 44.4475, "longitude": 26.0837 },
      ...
      "hasOfferCatalog": { "@type": "OfferCatalog", "name": "Produse Tâmplărie", "itemListElement": [
        {"@type":"Offer","itemOffered":{"@type":"Product","name":"Tâmplărie PVC Salamander BluEvolution 92"}},
        {"@type":"Offer","itemOffered":{"@type":"Product","name":"Tâmplărie PVC Salamander GreenEvolution 76"}},
        {"@type":"Offer","itemOffered":{"@type":"Product","name":"Tâmplărie Aluminiu Alumil S77 Supreme"}},
        {"@type":"Offer","itemOffered":{"@type":"Product","name":"Tâmplărie Aluminiu Alumil S67 Smartia"}},
        {"@type":"Offer","itemOffered":{"@type":"Product","name":"Geam Termoizolator 2 Foi"}},
        {"@type":"Offer","itemOffered":{"@type":"Product","name":"Geam Termoizolator 3 Foi"}},
        {"@type":"Offer","itemOffered":{"@type":"Product","name":"Precadre Blaugelb Triotherm+"}},
        {"@type":"Offer","itemOffered":{"@type":"Product","name":"Jaluzele Venețiene Raffstore"}},
        {"@type":"Offer","itemOffered":{"@type":"Product","name":"Rulouri Exterioare Aluminiu"}},
        {"@type":"Offer","itemOffered":{"@type":"Product","name":"Uși de Intrare Premium"}},
        {"@type":"Offer","itemOffered":{"@type":"Product","name":"Uși de Garaj"}}
      ]},
      "areaServed": [{"@type":"Country","name":"România"},{"@type":"Country","name":"Germania"},{"@type":"Country","name":"Austria"},{"@type":"Country","name":"Italia"},{"@type":"Country","name":"Franța"},{"@type":"Country","name":"Spania"}],
      "aggregateRating": { "@type": "AggregateRating", "ratingValue": "4.9", "reviewCount": "127", "bestRating": "5" }
    },
    {
      "@type": "FAQPage",
      "mainEntity": [
        {"@type":"Question","name":"Ce tipuri de tâmplărie PVC Salamander furnizați?","acceptedAnswer":{"@type":"Answer","text":"Furnizăm tâmplărie PVC Salamander din gamele BluEvolution 92 (6 camere, Uw 0.70 W/m²K) și GreenEvolution 76, certificate nZEB, executate pe linii de producție automatizate."}},
        {"@type":"Question","name":"Ce sisteme de tâmplărie aluminiu Alumil oferiți?","acceptedAnswer":{"@type":"Answer","text":"Oferim sisteme aluminiu Alumil S77 Supreme, S67 Smartia, S700, SF85, inclusiv sisteme glisante și lifturi pentru suprafețe vitrate mari, cu barieră termică certificată nZEB."}},
        {"@type":"Question","name":"Livrați și montați tâmplărie în afara României?","acceptedAnswer":{"@type":"Answer","text":"Da, Neofort BIZ livrează și montează tâmplărie PVC Salamander și aluminiu Alumil în toată Europa — Germania, Austria, Italia, Franța, Spania și alte țări UE."}},
        {"@type":"Question","name":"Ce înseamnă standard nZEB pentru ferestre?","acceptedAnswer":{"@type":"Answer","text":"nZEB (Nearly Zero Energy Building) este standardul european pentru clădiri cu consum aproape zero de energie. Ferestrele noastre PVC Salamander și aluminiu Alumil sunt certificate nZEB, asigurând economii de până la 50% la costurile de încălzire."}}
      ]
    }
  ]
};
    ...
    <>
      ...
      <section style={{padding:'40px 0 48px',borderBottom:'1px solid #e8e8e8'}}>
        <div className="container">
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'20px',maxWidth:'860px',margin:'0 auto'}}>
            <Link href="tamplarie-pvc" aria-label="Tâmplărie PVC Salamander — Vezi profile disponibile"
              style={{display:'flex',flexDirection:'column',justifyContent:'space-between',padding:'36px',background:'#fff',border:'1px solid #e8e8e8',textDecoration:'none'}}>
              ...
              <div>
                ...
                <h2 style={{fontFamily:'Barlow Condensed,sans-serif',fontWeight:400,fontSize:'2.6rem',color:'#1a1a1a',lineHeight:1.08,marginBottom:'18px',letterSpacing:'.01em'}}>Tâmplărie<br/><strong style={{fontWeight:600}}>PVC Salamander</strong></h2>
                <p style={{fontSize:'.8rem',fontWeight:300,color:'#999',lineHeight:1.75,maxWidth:'300px',marginBottom:'32px',textAlign:'justify'}}>Eficiență energetică nZEB și design atemporal pentru proiecte rezidențiale de top. BluEvolution 92 · GreenEvolution 76 · 6 camere.</p>
                <span className="btn btn-pvc">VEZI PROFILE</span>
              </div>
            </Link>
            <Link href="tamplarie-aluminiu" aria-label="Tâmplărie Aluminiu Alumil — Vezi sisteme disponibile"
              style={{display:'flex',flexDirection:'column',justifyContent:'space-between',padding:'36px',background:'#fff',border:'1px solid #e8e8e8',textDecoration:'none'}}>
              ...
              <div>
                ...
                <h2 style={{fontFamily:'Barlow Condensed,sans-serif',fontWeight:400,fontSize:'2.6rem',color:'#1a1a1a',lineHeight:1.08,marginBottom:'18px',letterSpacing:'.01em'}}>Tâmplărie<br/><strong style={{fontWeight:600}}>Aluminiu Alumil</strong></h2>
                <p style={{fontSize:'.8rem',fontWeight:300,color:'#999',lineHeight:1.75,maxWidth:'300px',marginBottom:'32px',textAlign:'justify'}}>Suprafețe vitrate mari și durabilitate extremă pentru arhitectura contemporană. S77 Supreme · S67 Smartia · SF85.</p>
        ...
        <div className="container">
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'56px',alignItems:'start'}}>
            <div>
              ...
              <h2 style={{fontFamily:'Barlow Condensed,sans-serif',fontWeight:500,fontSize:'1.9rem',color:'#1a1a1a',lineHeight:1.2,marginBottom:'18px',letterSpacing:'.01em'}}>Tâmplărie PVC Salamander<br/>și Aluminiu Alumil</h2>
            </div>
            <div/>
          </div>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',border:'1px solid #e8e8e8',marginTop:'48px'}}>
      ...
      <section style={{padding:'72px 0',background:'#f7f7f5',borderBottom:'1px solid #e8e8e8'}}>
        <div className="container">
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:'14px',marginTop:'8px'}}>
            {[
              ...
              <Link key={p.href} href={p.href} style={{display:'flex',flexDirection:'column',background:'#fff',border:`1px solid #e8e8e8`,borderTop:`3px solid ${p.topColor}`,textDecoration:'none',transition:'border-color .2s,box-shadow .2s'}} className="prod-card">
        ...
        <div className="container">
          <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-end',marginBottom:'36px',flexWrap:'wrap',gap:'16px'}}>
            <div>
              ...
              <h2 style={{fontFamily:'Barlow Condensed,sans-serif',fontWeight:500,fontSize:'2rem',color:'#1a1a1a',letterSpacing:'.01em'}}>Etapele colaborării</h2>
            </div>
            <p style={{fontSize:'.78rem',fontWeight:300,color:'#bbb',maxWidth:'220px',textAlign:'right',lineHeight:1.6}}>Claritate în 3 pași simpli. Specialiștii noștri vă însoțesc în fiecare etapă.</p>
          </div>
          <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',border:'1px solid #e8e8e8'}}>
            {[
              ...
              <div key={s.n} style={{padding:'36px 32px',borderRight:i<2?'1px solid #e8e8e8':'none'}}>
                ...
                <h3 style={{fontFamily:'Barlow Condensed,sans-serif',fontWeight:500,fontSize:'.95rem',color:'#1a1a1a',marginBottom:'10px',letterSpacing:'.02em'}}>{s.title}</h3>
        ...
        <div className="container">
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'72px',alignItems:'start'}}>
            <div>
              ...
              <h2 style={{fontFamily:'Barlow Condensed,sans-serif',fontWeight:500,fontSize:'2.2rem',color:'#1a1a1a',lineHeight:1.2,letterSpacing:'.01em'}}>Calitate și angajamente<br/>fără compromisuri</h2>
            </div>
            <div style={{display:'grid',gridTemplateColumns:'1fr 1fr'}}>
              {[
                ...
                <div key={i} style={{padding:'20px 18px',borderTop:'1px solid #e8e8e8',borderRight:i%2===0?'1px solid #e8e8e8':'none'}}>
