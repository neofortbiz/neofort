...
export default function HomePage() {
  return (
    <>
      {/* HERO — split 2 col, stil referinta */}
      <section className="grid grid-cols-1 md:grid-cols-2" style={{minHeight:'88vh', borderBottom:'1px solid #e5e5e5'}}>
        <Link href="tamplarie-pvc"
          ...
          <span className="text-[0.62rem] tracking-[0.22em] uppercase text-muted">
            Tehnologie Germană · Salamander
          </span>
          <div>
            <p className="text-[0.62rem] tracking-[0.22em] uppercase font-semibold font-condensed mb-4" style={{color:'#4a7c59'}}>
              Profile PVC Salamander
            </p>
            <h2 className="font-condensed font-semibold leading-none mb-5" style={{fontSize:'clamp(2.8rem,5vw,4rem)', color:'#1a1a1a'}}>
            ...
            <span className="inline-block font-condensed text-[0.68rem] font-semibold tracking-[0.18em] uppercase px-6 py-3 border transition-all duration-200"
              style={{border:'1px solid #4a7c59', color:'#4a7c59', background:'transparent'}}
        ...
        <Link href="tamplarie-aluminiu"
          ...
          <div>
            <p className="text-[0.62rem] tracking-[0.22em] uppercase font-semibold font-condensed mb-4" style={{color:'#2d5a8e'}}>
            ...
            <span className="inline-block font-condensed text-[0.68rem] font-semibold tracking-[0.18em] uppercase px-6 py-3 border transition-all duration-200"
              style={{border:'1px solid #2d5a8e', color:'#2d5a8e', background:'transparent'}}
              onMouseEnter={e=>{e.currentTarget.style.background='#2d5a8e';e.currentTarget.style.color='#fff'}}
              onMouseLeave={e=>{e.currentTarget.style.background='transparent';e.currentTarget.style.color='#2d5a8e'}}>
              Vezi Sisteme →
            </span>
          </div>
        </Link>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mt-6">
            <div>
              ...
              <p className="text-[0.88rem] text-muted leading-relaxed text-justify">
                Alegerea între <strong className="text-primary font-medium">tâmplărie PVC Salamander</strong> și <strong className="text-primary font-medium">tâmplărie aluminiu Alumil</strong> este definitorie pentru eficiența energetică a oricărei construcții moderne. La Neofort BIZ integrăm tehnologia de vârf cu designul minimalist pentru a oferi bariere termice de neegalat. Profilele noastre sunt certificate pentru standardele <strong className="text-primary font-medium">nZEB (Nearly Zero Energy Building)</strong>, asigurând o economie reală la costurile de încălzire.
              </p>
            </div>
            <div>
              <p className="text-[0.88rem] text-muted leading-relaxed text-justify">
                Fie că optați pentru robustețea sistemelor de <strong className="text-primary font-medium">aluminiu Alumil cu barieră termică</strong> sau pentru izolarea fonică superioară a <strong className="text-primary font-medium">ferestrelor PVC Salamander</strong>, echipa noastră oferă consultanță tehnică dedicată și montaj profesional cu izolare perimetrală completă. Ne concentrăm pe detalii esențiale precum <strong className="text-primary font-medium">bagheta warm-edge</strong> și pachete de sticlă tripan cu emisivitate scăzută pentru un confort termic impecabil.
              </p>
            </div>
          </div>

          {/* Stats — premium */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-0 mt-14 border border-[#e5e5e5] divide-x divide-[#e5e5e5]">
            {[
              ...
              <div key={l} className="p-7 text-center">
                ...
                <div className="text-[0.62rem] tracking-[0.12em] uppercase text-muted leading-tight">{l}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* PRODUSE — carduri mici, border hover */}
      <section className="py-20 bg-[#f7f7f5] border-b border-[#e5e5e5]">
        <div className="container mx-auto px-6">
            ...
            {[
              {
                ...
                desc: 'Furnizăm tâmplărie PVC Salamander BluEvolution 92 și GreenEvolution 76, din gamele premium. Tâmplăria PVC este executată pe linii de producție automatizate, certificată nZEB.',
                btnColor: '#4a7c59',
              },
              {
                ...
                desc: 'Furnizăm tâmplărie aluminiu Alumil din gamele Supreme și Smartia. Sisteme cu barieră termică pentru ferestre, uși, lifturi glisante și pereți cortină, certificate nZEB.',
                btnColor: '#2d5a8e',
              },
              {
                href: 'accesorii',
                ...
                desc: 'Oferim cele mai avansate soluții de izolare: bandă butilică, precadre Blaugelb Triotherm+, folie anticondens interior și exterior, rulouri aluminiu, geam termopan Saint Gobain.',
                btnColor: '#e8721c',
              },
            ].map(item => (
      ...
      <section className="py-20 border-b border-[#e5e5e5]">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-4">
            ...
            <p className="text-[0.85rem] text-muted max-w-xs text-right">Claritate în 3 pași simpli. Specialiștii noștri vă însoțesc în fiecare etapă.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 border border-[#e5e5e5]">
            {[
              ...
              <div key={s.n} className={`p-10 ${i < 2 ? 'border-b md:border-b-0 md:border-r border-[#e5e5e5]' : ''}`}>
                ...
                <p className="text-[0.84rem] text-muted leading-relaxed text-justify">{s.desc}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              {[
                ...
                <div key={i} className="border-t border-[#e5e5e5] pt-5">
                  ...
                  <p className="text-[0.8rem] text-muted leading-relaxed text-justify">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-20 bg-[#111]">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
          <div>
            <span className="text-[0.62rem] tracking-[0.22em] uppercase font-semibold font-condensed" style={{color:'#555'}}>Contactați-ne</span>
          ...
          <div className="flex flex-col sm:flex-row gap-3 shrink-0">
            <Link href="contact"
              className="font-condensed text-[0.68rem] tracking-[0.18em] uppercase font-semibold px-8 py-4 text-center transition-colors duration-200"
              style={{background:'#4a7c59', color:'#fff', border:'1px solid #4a7c59'}}>
              Cerere Ofertă
            </Link>
            <a href="tel:+40752443435"
              className="font-condensed text-[0.68rem] tracking-[0.18em] uppercase font-semibold px-8 py-4 text-center transition-all duration-200"
...
// Card component — hover: border accentuat + culoare buton
function ServiceCard({ href, topColor, tag, tagColor, title, desc, btnColor }) {
  return (
    <Link href={href} className="group block bg-white border border-[#e5e5e5] flex flex-col hover:border-[#ccc] hover:shadow-sm transition-all duration-200"
      style={{borderTop: `3px solid ${topColor}`}}>
      <div className="p-7 flex flex-col flex-1">
        <p className="text-[0.62rem] tracking-[0.2em] uppercase font-semibold font-condensed mb-3" style={{color: tagColor}}>{tag}</p>
        <h3 className="font-condensed text-xl font-semibold text-primary mb-3">{title}</h3>
        <p className="text-[0.8rem] text-muted leading-relaxed flex-1 text-justify">{desc}</p>
        <div className="mt-6">
          <span className="inline-block font-condensed text-[0.65rem] font-semibold tracking-[0.18em] uppercase px-5 py-2.5 border transition-all duration-200"
            style={{border:`1px solid #ccc`, color:'#999', background:'transparent'}}
            onMouseEnter={e=>{e.currentTarget.style.background=btnColor;e.currentTarget.style.color='#fff';e.currentTarget.style.borderColor=btnColor}}
            onMouseLeave={e=>{e.currentTarget.style.background='transparent';e.currentTarget.style.color='#999';e.currentTarget.style.borderColor='#ccc'}}>
            Detalii →
          </span>
        </div>
      </div>
