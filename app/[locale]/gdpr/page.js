...
const UI = {
  ro: {
    ...
    sections: [
      ...
      { h: '4. Procesatori terți autorizați', p: 'Resend Inc. (SUA) — serviciu de livrare e-mail, procesează datele din formular exclusiv pentru transmiterea mesajului la destinatarul intern oferte@neofort-biz.ro. Resend Inc. este certificat conform EU Standard Contractual Clauses (SCC). Datele nu sunt utilizate de Resend în alte scopuri. Nu folosim Google Analytics, Meta Pixel sau alte instrumente de tracking terț.' },
      ...
      { h: '9. Cookie-uri', p: 'Site-ul folosește exclusiv un cookie tehnic necesar funcționării (cookie_ok — stocat în localStorage, reține confirmarea bannerului de cookies). Nu folosim cookie-uri de tracking, publicitate, analiză sau social media. Nu există cookie-uri third-party. Puteți șterge cookies din setările browserului în orice moment.' },
  ...
  en: {
    ...
    sections: [
      ...
      { h: '9. Cookies', p: 'This site uses only one technically necessary cookie (cookie_ok — stored in localStorage, remembers cookie banner confirmation). We do not use tracking, advertising, analytics or social media cookies. There are no third-party cookies. You can delete cookies from your browser settings at any time.' },
  ...
  de: {
    ...
    sections: [
      ...
      { h: '4. Autorisierte Drittanbieter', p: 'Resend Inc. (USA) — E-Mail-Zustelldienst, verarbeitet Formulardaten ausschließlich zur Übermittlung der Nachricht an den internen Empfänger oferte@neofort-biz.ro. Resend Inc. ist nach EU Standard Contractual Clauses (SCC) zertifiziert. Daten werden von Resend nicht für andere Zwecke verwendet. Wir verwenden kein Google Analytics, Meta Pixel oder andere Tracking-Tools.' },
      ...
      { h: '9. Cookies', p: 'Diese Website verwendet nur ein technisch notwendiges Cookie (cookie_ok — im localStorage gespeichert, merkt die Cookie-Banner-Bestätigung). Wir verwenden keine Tracking-, Werbe-, Analyse- oder Social-Media-Cookies. Es gibt keine Drittanbieter-Cookies. Sie können Cookies jederzeit in Ihren Browsereinstellungen löschen.' },
  ...
  fr: {
    ...
    sections: [
      ...
      { h: '9. Cookies', p: 'Ce site utilise uniquement un cookie techniquement nécessaire (cookie_ok — stocké dans le localStorage, mémorise la confirmation de la bannière cookies). Nous n'utilisons pas de cookies de suivi, publicitaires, analytiques ou de réseaux sociaux. Aucun cookie tiers. Vous pouvez supprimer les cookies depuis les paramètres de votre navigateur.' },
  ...
  es: {
    ...
    sections: [
      ...
      { h: '9. Cookies', p: 'Este sitio utiliza únicamente una cookie técnicamente necesaria (cookie_ok — almacenada en localStorage, recuerda la confirmación del banner de cookies). No utilizamos cookies de seguimiento, publicidad, análisis o redes sociales. Sin cookies de terceros. Puede eliminar las cookies desde la configuración de su navegador.' },
  ...
  it: {
    ...
    sections: [
      ...
      { h: '9. Cookie', p: 'Questo sito utilizza esclusivamente un cookie tecnicamente necessario (cookie_ok — memorizzato nel localStorage, ricorda la conferma del banner cookie). Non utilizziamo cookie di tracciamento, pubblicitari, analitici o di social media. Nessun cookie di terzi. Può eliminare i cookie dalle impostazioni del browser in qualsiasi momento.' },
