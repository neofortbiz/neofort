...
const UI = {
  ro: {
    ...
    faq: [
      ...
      ['Oferiți factură fiscală cu TVA?', 'Da, toate lucrările sunt facturate cu TVA 21%. Emitem factură fiscală și documentație completă pentru dosarul de autorizație sau certificat energetic.'],
    ],
  ...
  en: {
    ...
    faq: [
      ...
      ['Do you issue a VAT invoice?', 'Yes, all works are invoiced with 21% VAT. We issue fiscal invoice and complete documentation for permit or energy certificate files.'],
    ],
  ...
  de: {
    ...
    faq: [
      ...
      ['Stellen Sie eine MwSt.-Rechnung aus?', 'Ja, alle Arbeiten werden mit 21% MwSt. fakturiert. Wir stellen Steuerrechnung und vollständige Dokumentation aus.'],
    ],
  ...
  fr: {
    ...
    faq: [
      ...
      ['Émettez-vous une facture avec TVA ?', 'Oui, tous les travaux sont facturés avec 21% de TVA. Nous émettons une facture fiscale et une documentation complète.'],
    ],
  ...
  es: {
    ...
    faq: [
      ...
      ['¿Emiten factura con IVA?', 'Sí, todos los trabajos se facturan con 21% de IVA. Emitimos factura fiscal y documentación completa.'],
    ],
  ...
  it: {
    ...
    faq: [
      ...
      ['Emettete fattura con IVA?', 'Sì, tutti i lavori sono fatturati con IVA al 21%. Emettiamo fattura fiscale e documentazione completa.'],
    ],
