...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    description: locale === 'ro' ? 'Tâmplărie aluminiu Alumil în București — cere o ofertă de preț personalizată, cu răspuns rapid. Ferestre, uși, glisante și pereți cortină cu barieră termică. Montaj propriu, 21 ani experiență, 5.0★ din 52 recenzii.'
               ...
               : locale === 'fr' ? 'Menuiserie aluminium Alumil à Bucarest — demandez un devis prix personnalisé, réponse rapide. Fenêtres, portes, coulissants et murs-rideaux à rupture de pont thermique. Pose par notre équipe, 21 ans d\u2019expérience, 5.0★ sur 52 avis.'
               : locale === 'es' ? 'Carpintería aluminio Alumil en Bucarest — solicita un presupuesto personalizado, respuesta rápida. Ventanas, puertas, correderas y muros cortina con rotura de puente térmico. Montaje propio, 21 años de experiencia, 5.0★ de 52 reseñas.'
               : 'Infissi alluminio Alumil a Bucarest — richiedi un preventivo prezzo personalizzato, risposta rapida. Finestre, porte, scorrevoli e facciate continue con taglio termico. Posa propria, 21 anni di esperienza, 5.0★ su 52 recensioni.',
...
export default async function TamplaieAluminiuPage({ params }) {
  ...
  // FAQPage generat din faqItems — sursa unica, localizata pe toate cele 6 limbi.
  ...
  const PILLAR_LABELS = {
    ro: 'Ghid Complet Tamplarie Aluminiu 2026 — Alumil S77, S67, M19800, sisteme',
    en: 'Complete Aluminium Guide 2026 — Alumil S77, S67, M19800 systems',
    de: 'Aluminiumfenster Ratgeber 2026 — Alumil S77, S67, M19800 Systeme',
    fr: 'Guide complet aluminium 2026 — Systemes Alumil S77, S67, M19800',
    es: 'Guia completa aluminio 2026 — Sistemas Alumil S77, S67, M19800',
    it: 'Guida completa alluminio 2026 — Sistemi Alumil S77, S67, M19800',
  };
  const PILLAR_CTA = {
